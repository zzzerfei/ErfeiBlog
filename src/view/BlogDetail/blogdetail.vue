<template>
  <div style="width: 100%">
    <div class="article allpage bg-white">
      <!-- <div
        v-show="!state.isLoading"
        :style="{'width': state.isMobileOrPc ? '100%' : '75%'}"
        class="article-left fl"
      > -->
      <div v-show="!state.isLoading" class="article-left fl">
        <div class="header">
          ...
          <div class="author">
            <div class="avatar">
              <img
                class="auth-logo"
                src="../../assets/img/myinfo/avator.jpg"
                alt="erfei"
              />
            </div>
            <div class="info">
              ...
              <div class="meta">
                ...
                <span class="wordage"> 字数 {{ state.articleDetail.numbers }} </span>
                <span class="views-count"> 阅读 {{ state.articleDetail.meta.views }} </span>
                <span class="comments-count"> 评论 {{ state.articleDetail.meta.comments }} </span>
                <span class="likes-count"> 喜欢 {{ state.articleDetail.meta.likes }} </span>
              </div>
            </div>
            <!-- 博客标签 -->
          ...
          <div class="blog_img">
            <img :src="state.articleDetail.img_url" alt="">
          </div>
        </div>
        <!-- 博客内容 -->
        <div class="content">
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      state.params.id = route.query.blog_id as string
      if (route.path === '/about') {
        state.params.type = 3
      }
      handleSearch()
